...
- Het attribuut `inhoud` in `BestandsDeelResponse` deprecated gemaakt omdat het geen nut heeft. Zie issue [#2633](https://github.com/VNG-Realisatie/gemma-zaken/issues/2633) en commit [101ed13](https://github.com/VNG-Realisatie/gemma-zaken/commit/101ed13d1e0984f9d0779cadcb03b83c2a5aaf51).
- Het attribuut `inhoudIsVervallen` van `enkelvoudiginformatieobject` voorzien van default waarde `null` inclusief een beschrijving van de betekenis van waarde `null` in de scope van dit attribuut. Zie issue  [#2632](https://github.com/VNG-Realisatie/gemma-zaken/issues/2632) en pull request [#2642](https://github.com/VNG-Realisatie/gemma-zaken/pull/2642).
- Veldselectie toegevoegd aan het `_zoek` endpoint van `enkelvoudiginformatieobjecten`. Zie issue [#2621](https://github.com/VNG-Realisatie/gemma-zaken/issues/2621) en commit [d86c04e](https://github.com/VNG-Realisatie/gemma-zaken/commit/d86c04eed71535b5937c44369f3212f6cfa2808e).
